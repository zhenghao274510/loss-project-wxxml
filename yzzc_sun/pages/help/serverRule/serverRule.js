...
Page(_extends({}, _reload.reload, {
    ...
    onRuleDetails: function(t) {
        var a = t.currentTarget.dataset.idx, e = (JSON.stringify(this.data.list[a]), this.data.list[a].title), i = this.data.list[a].content;
        this.navTo("../../ruledetails/ruledetails?title=" + e + "&content=" + i);
    }
}));